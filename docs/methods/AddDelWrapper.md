...
```
AddDelWrapper(estimator, score, maximize, seed).fit(X,y)
```
...
```bash
itmofs-lab info AddDelWrapper
itmofs-lab run AddDelWrapper --dataset breast_cancer
```
