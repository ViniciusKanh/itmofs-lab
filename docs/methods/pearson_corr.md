...
```
pearson_corr(X, y)  |  UnivariateFilter('pearson_corr', ('K best', k))
```
...
```bash
itmofs-lab info pearson_corr
itmofs-lab run pearson_corr --dataset breast_cancer
```
